...
declare class MarginPoolContract {
   ...
   */
  mintSupplierCap: () => (tx: Transaction) => _mysten_sui_transactions40.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  withdrawFromMarginPool: (coinKey: string, supplierCap: TransactionObjectArgument, amountToWithdraw?: number) => (tx: Transaction) => _mysten_sui_transactions40.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  withdrawReferralFees: (coinKey: string, referralId: string) => (tx: Transaction) => _mysten_sui_transactions40.TransactionResult;
  /**
   * @description Get the margin pool ID
   * @param {string} coinKey The key to identify the pool
   * @returns A function that takes a Transaction object
   */
  getId: (coinKey: string) => (tx: Transaction) => _mysten_sui_transactions40.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  deepbookPoolAllowed: (coinKey: string, deepbookPoolId: string) => (tx: Transaction) => _mysten_sui_transactions40.TransactionResult;
  /**
   * @description Get the total supply amount
   * @param {string} coinKey The key to identify the pool
   * @returns A function that takes a Transaction object
   */
  totalSupply: (coinKey: string) => (tx: Transaction) => _mysten_sui_transactions40.TransactionResult;
  /**
   * @description Get the total supply shares
   * @param {string} coinKey The key to identify the pool
   * @returns A function that takes a Transaction object
   */
  supplyShares: (coinKey: string) => (tx: Transaction) => _mysten_sui_transactions40.TransactionResult;
  /**
   * @description Get the total borrow amount
   * @param {string} coinKey The key to identify the pool
   * @returns A function that takes a Transaction object
   */
  totalBorrow: (coinKey: string) => (tx: Transaction) => _mysten_sui_transactions40.TransactionResult;
  /**
   * @description Get the total borrow shares
   * @param {string} coinKey The key to identify the pool
   * @returns A function that takes a Transaction object
   */
  borrowShares: (coinKey: string) => (tx: Transaction) => _mysten_sui_transactions40.TransactionResult;
  /**
   * @description Get the last update timestamp
   * @param {string} coinKey The key to identify the pool
   * @returns A function that takes a Transaction object
   */
  lastUpdateTimestamp: (coinKey: string) => (tx: Transaction) => _mysten_sui_transactions40.TransactionResult;
  /**
   * @description Get the supply cap
   * @param {string} coinKey The key to identify the pool
   * @returns A function that takes a Transaction object
   */
  supplyCap: (coinKey: string) => (tx: Transaction) => _mysten_sui_transactions40.TransactionResult;
  /**
   * @description Get the max utilization rate
   * @param {string} coinKey The key to identify the pool
   * @returns A function that takes a Transaction object
   */
  maxUtilizationRate: (coinKey: string) => (tx: Transaction) => _mysten_sui_transactions40.TransactionResult;
  /**
   * @description Get the protocol spread
   * @param {string} coinKey The key to identify the pool
   * @returns A function that takes a Transaction object
   */
  protocolSpread: (coinKey: string) => (tx: Transaction) => _mysten_sui_transactions40.TransactionResult;
  /**
   * @description Get the minimum borrow amount
   * @param {string} coinKey The key to identify the pool
   * @returns A function that takes a Transaction object
   */
  minBorrow: (coinKey: string) => (tx: Transaction) => _mysten_sui_transactions40.TransactionResult;
  /**
   * @description Get the current interest rate
   * @param {string} coinKey The key to identify the pool
   * @returns A function that takes a Transaction object
   */
  interestRate: (coinKey: string) => (tx: Transaction) => _mysten_sui_transactions40.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  userSupplyShares: (coinKey: string, supplierCapId: string) => (tx: Transaction) => _mysten_sui_transactions40.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  userSupplyAmount: (coinKey: string, supplierCapId: string) => (tx: Transaction) => _mysten_sui_transactions40.TransactionResult;
}
//#endregion
