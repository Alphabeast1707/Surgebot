...
import * as _mysten_sui_transactions57 from "@mysten/sui/transactions";
...
declare class PoolProxyContract {
   ...
   */
  placeLimitOrder: (params: PlaceMarginLimitOrderParams) => (tx: Transaction) => _mysten_sui_transactions57.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  placeMarketOrder: (params: PlaceMarginMarketOrderParams) => (tx: Transaction) => _mysten_sui_transactions57.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  placeReduceOnlyLimitOrder: (params: PlaceMarginLimitOrderParams) => (tx: Transaction) => _mysten_sui_transactions57.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  placeReduceOnlyMarketOrder: (params: PlaceMarginMarketOrderParams) => (tx: Transaction) => _mysten_sui_transactions57.TransactionResult;
  /**
