...
declare class MarginMaintainerContract {
   ...
   * @returns A function that takes a Transaction object
   */
  newProtocolConfig: (coinKey: string, marginPoolConfig: MarginPoolConfigParams, interestConfig: InterestConfigParams) => (tx: Transaction) => _mysten_sui_transactions5.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  newMarginPoolConfig: (coinKey: string, marginPoolConfig: MarginPoolConfigParams) => (tx: Transaction) => _mysten_sui_transactions5.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  newMarginPoolConfigWithRateLimit: (coinKey: string, marginPoolConfig: Required<Pick<MarginPoolConfigParams, "rateLimitCapacity" | "rateLimitRefillRatePerMs" | "rateLimitEnabled">> & MarginPoolConfigParams) => (tx: Transaction) => _mysten_sui_transactions5.TransactionResult;
  /**
   * @description Create a new interest config
   * @param {InterestConfigParams} interestConfig The configuration for the interest
   * @returns A function that takes a Transaction object
   */
  newInterestConfig: (interestConfig: InterestConfigParams) => (tx: Transaction) => _mysten_sui_transactions5.TransactionResult;
  /**
