...
declare class MarginTPSLContract {
   ...
   */
  newCondition: (poolKey: string, triggerBelowPrice: boolean, triggerPrice: number | bigint) => (tx: Transaction) => _mysten_sui_transactions61.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  newPendingLimitOrder: (poolKey: string, params: PendingLimitOrderParams) => (tx: Transaction) => _mysten_sui_transactions61.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  newPendingMarketOrder: (poolKey: string, params: PendingMarketOrderParams) => (tx: Transaction) => _mysten_sui_transactions61.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  executeConditionalOrders: (managerAddress: string, poolKey: string, maxOrdersToExecute: number) => (tx: Transaction) => _mysten_sui_transactions61.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  conditionalOrderIds: (poolKey: string, marginManagerId: string) => (tx: Transaction) => _mysten_sui_transactions61.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  conditionalOrder: (poolKey: string, marginManagerId: string, conditionalOrderId: string) => (tx: Transaction) => _mysten_sui_transactions61.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  lowestTriggerAbovePrice: (poolKey: string, marginManagerId: string) => (tx: Transaction) => _mysten_sui_transactions61.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  highestTriggerBelowPrice: (poolKey: string, marginManagerId: string) => (tx: Transaction) => _mysten_sui_transactions61.TransactionResult;
}
//#endregion
