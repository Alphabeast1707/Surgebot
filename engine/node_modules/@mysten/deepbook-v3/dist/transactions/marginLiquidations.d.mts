...
import * as _mysten_sui_transactions138 from "@mysten/sui/transactions";
...
declare class MarginLiquidationsContract {
   ...
   */
  withdraw: (vaultId: string, liquidationAdminCap: string, coinKey: string, amount: number) => (tx: Transaction) => _mysten_sui_transactions138.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  balance: (vaultId: string, coinKey: string) => (tx: Transaction) => _mysten_sui_transactions138.TransactionResult;
}
//#endregion
