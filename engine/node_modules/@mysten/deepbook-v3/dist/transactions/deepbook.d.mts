 ...
 */
declare class DeepBookContract {
  #private;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  withdrawSettledAmountsManagerID: (poolKey: string, balanceManagerId: string) => (tx: Transaction) => void;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  getPoolReferralBalances: (poolKey: string, referral: string) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  poolReferralMultiplier: (poolKey: string, referral: string) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
  /**
   * @description Check if a pool is a stable pool
   * @param {string} poolKey The key to identify the pool
   * @returns A function that takes a Transaction object
   */
  stablePool: (poolKey: string) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
  /**
   * @description Check if a pool is registered
   * @param {string} poolKey The key to identify the pool
   * @returns A function that takes a Transaction object
   */
  registeredPool: (poolKey: string) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  getQuoteQuantityOutInputFee: (poolKey: string, baseQuantity: number | bigint) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  getBaseQuantityOutInputFee: (poolKey: string, quoteQuantity: number | bigint) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  getQuantityOutInputFee: (poolKey: string, baseQuantity: number | bigint, quoteQuantity: number | bigint) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  getBaseQuantityIn: (poolKey: string, targetQuoteQuantity: number | bigint, payWithDeep: boolean) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  getQuoteQuantityIn: (poolKey: string, targetBaseQuantity: number | bigint, payWithDeep: boolean) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  getAccountOrderDetails: (poolKey: string, managerKey: string) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  getOrderDeepRequired: (poolKey: string, baseQuantity: number | bigint, price: number | bigint) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  accountExists: (poolKey: string, managerKey: string) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
  /**
   * @description Get the next epoch trade parameters for a pool
   * @param {string} poolKey The key to identify the pool
   * @returns A function that takes a Transaction object
   */
  poolTradeParamsNext: (poolKey: string) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
  /**
   * @description Get the quorum for a pool
   * @param {string} poolKey The key to identify the pool
   * @returns A function that takes a Transaction object
   */
  quorum: (poolKey: string) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
  /**
   * @description Get the pool ID
   * @param {string} poolKey The key to identify the pool
   * @returns A function that takes a Transaction object
   */
  poolId: (poolKey: string) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  canPlaceLimitOrder: (params: CanPlaceLimitOrderParams) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  canPlaceMarketOrder: (params: CanPlaceMarketOrderParams) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  checkMarketOrderParams: (poolKey: string, quantity: number | bigint) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
  /**
   ...
   * @returns A function that takes a Transaction object
   */
  checkLimitOrderParams: (poolKey: string, price: number | bigint, quantity: number | bigint, expireTimestamp: number) => (tx: Transaction) => _mysten_sui_transactions80.TransactionResult;
}
//#endregion
export { DeepBookContract };
//# sourceMappingURL=deepbook.d.mts.map