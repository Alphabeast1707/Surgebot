...
declare class DeepBookAdminContract {
   ...
   */
  deauthorizeMarginApp: () => (tx: Transaction) => _mysten_sui_transactions99.TransactionResult;
  /**
   ...
   */
  mintCorePauseCap: () => (tx: Transaction) => _mysten_sui_transactions99.TransactionResult;
  /**
   ...
   */
  corePauseCaps: () => (tx: Transaction) => _mysten_sui_transactions99.TransactionResult;
}
//#endregion
